...
buttonAddition.addEventListener("click", function(){
    var calculResultat = calculManager.addition(parseInt(chiffreSaisi.value));//{calculManager}
    afficherResultat(calculResultat);
})

buttonFactorielle.addEventListener("click", function(){
    var calculResultat = calculManager.factorielle(parseInt(chiffreSaisi.value));//{calculManager}
    afficherResultat(calculResultat);
})